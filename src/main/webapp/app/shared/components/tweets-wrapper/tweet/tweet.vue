<template>
  <!-- tweet start -->
  <div
    class="tweet cursor-pointer hover:bg-gray-100 transition-3 border border-l-0 border-r-0 border-t-0 p-4 pb-0">
    <div class="flex">
      <div class="w-auto">
        ...
        <div class="tweet-tweet">
          ...
          <div class="tweet-info-bar flex items-center ">
            ...
            <span class="tweet-username relative block">
                                                    <a href="#"
                                                       class="hover:underline text-gray-900 font-bold text-base mr-1">Shelly Walia</a>
                                                    <span class="w-4 inline-block twitter-color verified">
                                                        <svg viewBox="0 0 24 24" aria-label="Verified account"
                                                             class="r-13gxpu9 r-4qtqp9 r-yyyyoo r-1xvli5t r-9cviqr r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"><g><path
            ...
            <span
              class="text-gray-600 text-base font-light tracking-wide inline-block ml-1">@shellywalia</span>
          ...
          <div class="tweet-detail">
            <p>
              The legacy of tomorrow will come from the work we put in today <a class="font-semibold"
                                                                                href="##MondayMotivation">#MondayMotivation</a>
            </p>
          </div>
          <!-- tweet detail end -->
          <!-- tweet images start -->
          <div class="tweet-images py-3 pb-1">
                                                <span class="inline-block rounded-lg overflow-hidden h-64 shadow">
                                                    <img class="h-64 object-cover object-bottom w-full"
                                                         src="https://pbs.twimg.com/media/EG0lmlBX4AAdJpY?format=jpg&name=900x900"
                                                         alt="tweet image">
                                                </span>
          </div>
          <!-- tweet images end -->
                ...
                <div class="inline-flex ficon-wrapper comment text-gray-600">
                                                            <span class="ficon comment rounded-full">
                                                                <svg viewBox="0 0 24 24"
                                                                     class="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi"><g><path
              ...
              <div class="inline-block w-full">
                <div class="inline-flex ficon-wrapper send text-gray-600">
                                                            <span class="ficon send rounded-full">
                                                                <svg viewBox="0 0 24 24"
                                                                     class="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi"><g><path
                                                                  d="M17.53 7.47l-5-5c-.293-.293-.768-.293-1.06 0l-5 5c-.294.293-.294.768 0 1.06s.767.294 1.06 0l3.72-3.72V15c0 .414.336.75.75.75s.75-.336.75-.75V4.81l3.72 3.72c.146.147.338.22.53.22s.384-.072.53-.22c.293-.293.293-.767 0-1.06z"></path><path
                                                                  d="M19.708 21.944H4.292C3.028 21.944 2 20.916 2 19.652V14c0-.414.336-.75.75-.75s.75.336.75.75v5.652c0 .437.355.792.792.792h15.416c.437 0 .792-.355.792-.792V14c0-.414.336-.75.75-.75s.75.336.75.75v5.652c0 1.264-1.028 2.292-2.292 2.292z"></path></g></svg>
                                                            </span>
...
<script lang="ts" src="./tweet.component.ts"></script>
