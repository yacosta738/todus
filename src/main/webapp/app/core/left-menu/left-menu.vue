<template>
  <!-- left column start -->
  <div class="sticky h-screen overflow-y-auto top-0 w-3/12 flex-none px-4 py-0">

    <div class="inner pr-12 px-4 py-1" id="leftNavbar">

      <!-- logo start -->
      <div
        class="logo twitter-color w-12 transition-3 twitter-light-blue-on-hover p-2 ml-2 cursor-pointer rounded-full">
          ...
          <li class="side-navigation-list-item">
            <a href="#" class="clearfix w-auto p-2 px-4 mt-2 transition-3 inline-block rounded-full">
              <i class="icon float-left image">
                <img src="https://pbs.twimg.com/profile_images/1192060406627545089/SWlYzx4n_normal.jpg"
                     alt="profile image block" class="rounded-full shadow">
              </i>
...
<script lang="ts" src="./left-menu.component.ts"></script>
