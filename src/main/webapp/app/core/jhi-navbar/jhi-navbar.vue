<template>
  <!-- left column start -->
  <nav class="sticky h-screen overflow-y-auto top-0 w-3/12 flex-none px-4 py-0">
    <div class="inner pr-12 px-4 py-1" id="leftNavbar">
      ...
      <div class="side-navigation my-2">
        ...
        <ul class="side-navigation-list">
          ...
          <!-- side navigation list item start -->
          <li class="side-navigation-list-item">
            <router-link :to="{ name: 'Settings' }" class="clearfix w-auto p-2 px-4 mt-2 transition-3 inline-block rounded-full">
