...
export default class Tweets extends mixins(JhiDataUtils) {
  ...
  public retrieveAllTweetss(): void {
  ...
  public prepareRemove(instance: ITweets): void {
  ...
  public removeTweets(): void {
    this.tweetsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('todusApp.tweets.deleted', { param: this.removeId });
