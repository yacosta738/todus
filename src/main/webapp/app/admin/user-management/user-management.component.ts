...
export default class TodusUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-todusapp-alert'], {
          param: decodeURIComponent(res.headers['x-todusapp-params'].replace(/\+/g, ' ')),
        });
