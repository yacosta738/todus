...
export default class TodusUserManagementEdit extends Vue {
  ...
  private getMessageFromHeader(res: any): any {
    return this.$t(res.headers['x-todusapp-alert'], { param: decodeURIComponent(res.headers['x-todusapp-params'].replace(/\+/g, ' ')) });
  }
}
